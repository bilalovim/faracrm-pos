...
import type { ChatExternalChatRecord } from '@/types/records';
...
export function ViewFormExternalChat(props: ViewFormProps) {
  ...
  return (
    <Form<ChatExternalChatRecord> model="chat_external_chat" {...props}>
      <FormSection
        title={t('externalChat.sections.connection')}
      ...
      <FormSection
        title={t('externalChat.sections.relations')}
